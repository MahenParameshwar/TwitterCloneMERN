...
export const GET_RECOMDATIONS_REQUEST = "GET_RECOMDATIONS_REQUEST";
export const GET_RECOMDATIONS_SUCCESS = "GET_RECOMDATIONS_SUCCESS";
export const GET_RECOMDATIONS_FAILURE = "GET_RECOMDATIONS_FAILURE";
